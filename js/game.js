...
(function () {
  ...
  const ENTITIES = [
    ...
    { id: 'frame_instagram', x: 2, y: 12, w: 1, h: 1, kind: 'frame', wall: 'left', core: true, group: 'contact', kicker: 'Instagram', title: 'On Instagram', body: 'Drone aerials, street food, and golden hour over LA. The visual proof the camera gear earns its shelf space.', link: 'https://www.instagram.com/isaacabelperez', linkLabel: 'Open Instagram' },
